...
const GroupChatScreen = () => {
  const { chatId, groupName } = useParams();
  ...
  useEffect(() => {
    ...
    socket.emit("getGroupChatMessages", { chatId, email: user.email });

    socket.on("groupMessages", async (groupMessages) => {
      setIsTranslating(true);
      const translatedMessages = await translateMessages(groupMessages);
